data   = np.loadtxt('/disk1/mjw/HOD_MockRun/Data/Del2k/midK_Del2k_FullCube_Jenkins2.0.dat')
pl.loglog(data[:,0], 2.**3*data[:,2], 'r^', label='real space')

#zdata   = np.loadtxt('/disk1/mjw/HOD_MockRun/Data/Del2k/midK_Del2k_zFullCube.dat')
#pl.loglog(zdata[:,0], 4.**3*zdata[:, 2], 'g^', label='redshift space')
...
pl.savefig('/disk1/mjw/HOD_MockRun/Plots/z2Pk/monopole.pdf')
