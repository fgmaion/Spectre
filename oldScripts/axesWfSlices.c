int printWindowfuncSlices(){
    ...
    sprintf(Windowfunc_xSlice, "%s/%s_xSlice_NGPCorr.dat", WindowfuncSlices_dir, surveyType);
    WindowfuncSlice(kIntervalx, n2, 1, 0, 0, Windowfunc_xSlice);
    
    sprintf(Windowfunc_ySlice, "%s/%s_ySlice_NGPCorr.dat", WindowfuncSlices_dir, surveyType);
    WindowfuncSlice(kIntervaly, n1, 0, 1, 0, Windowfunc_ySlice);
    
    sprintf(Windowfunc_zSlice, "%s/%s_zSlice_NGPCorr.dat", WindowfuncSlices_dir, surveyType);
