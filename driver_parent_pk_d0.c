...
int main(int argc, char **argv){
  ...
  */
  ...
  //for(loopCount=38; loopCount<39; loopCount++){
    ...
    if(loopCount<10)        sprintf(filepath, "%s/mocks_v1.7/W%d/mock_00%d_parent_VAC.dat", vipersHOD_dir, fieldFlag, loopCount); // latest spec cats.
    ...
    daccepted_gals = assignAcceptance_parent();
