...
int set_files(char survey[], char logfile[]){
  sprintf(surveyType, survey, fieldFlag, fkpPk, lo_zlim, hi_zlim);

  sprintf(logfilepath, logfile, root_dir, fieldFlag, fkpPk, lo_zlim, hi_zlim);
...
int main(int argc, char **argv){
  ...
  zerolog  =               log10(0.001);
  maxlog   =       log10(atof(argv[6]));    // hiRes: 20., lowRes: 2000.
  ...
  double sampling_frac  = atof(argv[7]);
  ...
  int count_res         = atoi(argv[8]);

  if(count_res == 0){                                                     
    set_files("maskmultipoles_W%d_Nagoya_v7_Samhain_incmock_specweight_nbar_fkpweighted_%.2f_xi_%.1f_%.1f_hihiRes_hex", 
       "%s/W1_Spectro_V7_4/Qmultipoles/logfiles/maskmultipoles_W%d_Nagoya_v7_Samhain_incmock_specweight_nbar_fkpweighted_%.2f_xi_%.1f_%.1f_hihiRes_hex.dat"); 
  }                                                                                                                                                        
                                                     
  else if(count_res == 1){
    set_files("maskmultipoles_W%d_Nagoya_v7_Samhain_incmock_specweight_nbar_fkpweighted_%.2f_xi_%.1f_%.1f_hiRes_hex",
       "%s/W1_Spectro_V7_4/Qmultipoles/logfiles/maskmultipoles_W%d_Nagoya_v7_Samhain_incmock_specweight_nbar_fkpweighted_%.2f_xi_%.1f_%.1f_hiRes_hex.dat");
  }

  else if(count_res == 2){
    set_files("maskmultipoles_W%d_Nagoya_v7_Samhain_incmock_specweight_nbar_fkpweighted_%.2f_xi_%.1f_%.1f_loRes_hex",
       "%s/W1_Spectro_V7_4/Qmultipoles/logfiles/maskmultipoles_W%d_Nagoya_v7_Samhain_incmock_specweight_nbar_fkpweighted_%.2f_xi_%.1f_%.1f_loRes_hex.dat");
  }
    
  else if(count_res == 3){
    set_files("maskmultipoles_W1W4_Nagoya_v7_Samhain_incmock_specweight_nbar_fkpweighted_%.2f_xi_%.1f_%.1f_hihiRes_hex",
       "%s/W1_Spectro_V7_4/Qmultipoles/logfiles/maskmultipoles_W1W4_Nagoya_v7_Samhain_incmock_specweight_nbar_fkpweighted_%.2f_xi_%.1f_%.1f_hihiRes_hex.dat");
  }

  else if(count_res == 4){
    set_files("maskmultipoles_W1W4_Nagoya_v7_Samhain_incmock_specweight_nbar_fkpweighted_%.2f_xi_%.1f_%.1f_hiRes_hex", 
       "%s/W1_Spectro_V7_4/Qmultipoles/logfiles/maskmultipoles_W1W4_Nagoya_v7_Samhain_incmock_specweight_nbar_fkpweighted_%.2f_xi_%.1f_%.1f_hiRes_hex.dat");
  }

  else if(count_res == 5){
    set_files("maskmultipoles_W1W4_Nagoya_v7_Samhain_incmock_specweight_nbar_fkpweighted_%.2f_xi_%.1f_%.1f_loRes_hex", "%s/W1_Spectro_V7_4/Qmultipoles/logfiles/maskmultipoles_W1W4_Nagoya_v7_Samhain_incmock_specweight_nbar_fkpweighted_%.2f_xi_%.1f_%.1f_loRes_hex.dat");
  }

  // Initialise log file with start time. 
  time(&timer);
  ...
  // load randoms with sampling sampling_frac.                                                                                                             
  load_homogeneous_rands_window(sampling_frac); 
