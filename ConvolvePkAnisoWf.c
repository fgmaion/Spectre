int EstimateAnisoWfKernel(){
    ...
    printf("\nUpper Wf kenel x limit: %f", 0.5*(wfKernelsize-1)*kIntervalx);
    printf("\nUpper Wf kenel y limit: %f", 0.5*(wfKernelsize-1)*kIntervaly);
    printf("\nUpper Wf kenel z limit: %f", 0.5*(wfKernelsize-1)*kIntervalz);
